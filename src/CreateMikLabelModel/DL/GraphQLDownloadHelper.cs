...
{
//    internal class GraphQLDownloadHelper
//    {
...
//            try
//            {
//                foreach (RepositoryInformation repo in repositories)
//                {
//                    using (var client = CommonHelper.CreateGraphQLClient())
//                    {
//                        Trace.WriteLine($"Downloading Issue records from {repo.Owner}/{repo.Name}.");
//                        if (!await ProcessGitHubIssueData(
//                            client, repo.Owner, repo.Name, IssueType.Issue, outputLinesExcludingHeader, GetGitHubIssuePage<IssuesNode>))
//                        {
//                            return false;
//                        }
//                        Trace.WriteLine($"Downloading PR records from {repo.Owner}/{repo.Name}.");
//                        if (!await ProcessGitHubIssueData(
//                            client, repo.Owner, repo.Name, IssueType.PullRequest, outputLinesExcludingHeader, GetGitHubIssuePage<PullRequestsNode>))
//                        {
//                            return false;
//                        }
//                    }
...
//        {
//            return issue.Labels.Nodes.Any(l => LabelHelper.IsServiceLabel(l));
//        }
...
//            var area = issue.Labels.Nodes.First(l => LabelHelper.IsServiceLabel(l)).Name;
